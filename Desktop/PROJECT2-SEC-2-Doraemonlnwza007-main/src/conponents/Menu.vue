...
const emits = defineEmits(['next-state', 'user-name','history-state','cross-hair'])
...
const loginCheckerEditor = async (stat) =>{
  try {
    ...
    if (loginStatus.ok) {
      ...
      console.log(checky.value.status);
    } else {
      console.log("Don't get");
    }
  } catch (error) {
...
const logout = () => {
  if (name.value === "") {
    ...
    showpassword.value = ""
    router.push({ name: 'Menu'})
    // emits('user-name', showname.value)
    Msg("Logout Success")
...
const crosshair = () => {
  if (name.value === "") {
    ...
    router.push({ name: 'Croo', params: { name: params.name } })
  }
    ...
    <div class="modal">
      <div class="modal-box h-98 border-4 border-blue-300 bg-sky-900 ">
        ...
        <div class=" flex justify-center ">
          ...
          <h3>Username : <span><input class="text-black bg-white" type="text" placeholder="username" v-model="showname"></span>
          </h3>
          <h3>Password : <span><input class="text-black  bg-white" type="password" placeholder="password"
                v-model="showpassword"></span></h3>
        </div>
    ...
    <div class="modal">
      <div class="modal-box border-4 border-blue-300 bg-sky-900">
        ...
        <div class=" flex flex-col justify-center space-y-4 ">
          <h3>Username : <span><input class="text-black bg-white" type="text" placeholder="username" v-model="userregister"></span>
          </h3>
          <h3>Password : <span><input class="text-black bg-white" type="password" placeholder="password"
                v-model="passwordregister"></span></h3>
          <h3>Confirm Password : <span><input class="text-black bg-white" type="password" placeholder="confirm password"
                v-model="passwordconfirmregister"></span></h3>
        </div>
        <div class="modal-action flex justify-center">
    ...
    <div class="modal">
      <div class="modal-box border-4 border-blue-300 bg-sky-900">
        ...
        <div class=" flex flex-col justify-center space-y-4 ">
          ...
          <h3>Username : <span><input class="text-black bg-white" type="text" placeholder="username" v-model="userchange"></span>
          </h3>
          <h3>Password : <span><input class="text-black bg-white" type="password" placeholder="password"
                v-model="passwordchange"></span></h3>
          <h3>Confirm Password : <span><input class="text-black bg-white" type="password" placeholder="confirm password"
                v-model="passwordconfirmchange"></span></h3>
...
<div>
    ...
    <div class="modal -mt-">
      ...
      <!-- <div class="flex flex-col w-96 ml-10  justify-start absolute " v-show="cheackMsg">
        <div class="bg-orange-100 border-t-4 rounded-t-lg border-orange-500 text-orange-700 p-4 mb-2">
          <p class="font-bold text-xl"> ✉️ Message</p>
          <p class="text-lg"> {{ namealeart }}</p>
        </div>
      </div> -->
